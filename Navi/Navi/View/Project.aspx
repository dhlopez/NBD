            ...
            <div class="row fa-border">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DropDownList11" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource6" DataTextField="projName" DataValueField="ID" AppendDataBoundItems="True">
                            <asp:ListItem Selected="True" Value="0">All Projects</asp:ListItem>
                        </asp:DropDownList>

                        <asp:Label ID="Label3" runat="server" Text="Client"></asp:Label>
                        <asp:DropDownList ID="DropDownList9" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource4" DataTextField="cliName" DataValueField="ID" AppendDataBoundItems="True">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DropDownList10" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource3" DataTextField="Designer" DataValueField="ID" AppendDataBoundItems="True">
