...
<body>
    ...
    <div class="container">
        <form id="form1" runat="server">
            ...
            <div class="row">
                <h3>Project Name:</h3>
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" DataSourceID="ObjectDataSource14" DataTextField="projName" DataValueField="ID" AutoPostBack="True" Width="350">
                </asp:DropDownList>
            </div>
