...
<head runat="server">
    ...
    <style>
        /* to account form gridviews larg width*/
        .container2 {
            width: 100%;
        }
...
<body>
    ...
    <form id="form1" runat="server">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu" style="padding: 10px; padding-bottom: 0px;">
                                <div class="form-group">
                                    <asp:DetailsView ID="DetailsView1" runat="server" CssClass="form-control" AutoGenerateRows="False" DataKeyNames="ID" DataSourceID="ObjectDataSource5" DefaultMode="Insert" EnableViewState="False">
                                        <Fields>
            ...
            <div class="row fa-border">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DropDownList11" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource6" DataTextField="projName" DataValueField="ID">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DropDownList9" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource4" DataTextField="cliName" DataValueField="ID">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="DropDownList10" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="ObjectDataSource3" DataTextField="Designer" DataValueField="ID">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control" AutoPostBack="True"></asp:TextBox>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped gridview" GridLines="None" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="ObjectDataSource5">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Designer" InsertVisible="False" SortExpression="designerID">
                        <EditItemTemplate>
                            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource3" DataTextField="Designer" DataValueField="ID" SelectedValue='<%# Bind("designerID") %>'>
                            </asp:DropDownList>
                        </EditItemTemplate>
                        <ItemTemplate>
        ...
        <p>
            <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="MultiTable2.NBD_SBDataSet1TableAdapters.PROJECTTableAdapter" UpdateMethod="Update">
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList11" Name="Param1" PropertyName="SelectedValue" Type="Int32" />
                    <asp:ControlParameter ControlID="DropDownList9" Name="Param2" PropertyName="SelectedValue" Type="Int32" />
                    <asp:ControlParameter ControlID="DropDownList10" Name="Param3" PropertyName="SelectedValue" Type="Int32" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" DeleteMethod="Delete" SelectMethod="GetData" TypeName="MultiTable2.NBD_SBDataSet3AllClientsTableAdapters.CLIENTTableAdapter" UpdateMethod="Update">
            <DeleteParameters>
                <asp:Parameter Name="Original_ID" Type="Int32" />
