...
<body>
    ...
    <div class="container">
        <form id="form1" runat="server">
                ...
                <div class="form-group form-group-sm">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-3">
                            ...
                            <asp:TextBox ID="txtBidDate" runat="server" class="form-control"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-3">
                            ...
                            <asp:DropDownList ID="ddlProject" runat="server" class="form-control" AutoPostBack="True" DataSourceID="BIDProjectIDValue" DataTextField="projName" DataValueField="ID">
                            </asp:DropDownList>
                        </div>
            ...
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-striped" GridLines="None" DataKeyNames="ID" DataSourceID="BIDProj">
                <Columns>
        ...
        <asp:ObjectDataSource ID="BIDProj" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="BidLibrary.ProjectDataSetTableAdapters.BID_ProjectTableAdapter" UpdateMethod="Update">
            <DeleteParameters>
                <asp:Parameter Name="Original_ID" Type="Int32" />
