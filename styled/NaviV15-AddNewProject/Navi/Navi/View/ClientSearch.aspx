...
<body>
    ...
    <div class="container">
        <form id="form1" runat="server">
            <div class="row">
                <div class="col-md-8">
                    <h1><i class="fa fa-search" aria-hidden="true"></i>Client Search </h1>
                </div>
     ...
     <%--Projects formview End--%>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h3>
                        <asp:Label ID="Label1" runat="server" Text="NBD Staff" Visible="False"></asp:Label></h3>
